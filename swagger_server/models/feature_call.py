...
class FeatureCall(Model):
    ...
    """
    def __init__(self, alleles: List[str]=None, features_searched: List[str]=None, matched: List[Typing]=None, act_version: str=None, gfe_version: str=None, gfedb_version: str=None):
        """
    ...
    @matched.setter
    def matched(self, matched: List[Typing]):
        """
