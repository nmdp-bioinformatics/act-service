...
class AlleleCall(Model):
    ...
    """
    def __init__(self, typing: List[Typing]=None, ihiw_ref: List[Typing]=None, features: List[Feature]=None, gfe: str=None, act_version: str=None, gfe_version: str=None, gfedb_version: str=None):
        """
