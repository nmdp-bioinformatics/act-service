...
class InlineResponse2003(Model):
    ...
    def __init__(self, alleles: List[str]=None, features_searched: List[str]=None, matched: List[InlineResponse200Typing]=None, act_version: str=None, gfe_version: str=None, gfedb_version: str=None):
        ...
        :param alleles: The alleles of this InlineResponse2003.
        :type alleles: List[str]
        :param features_searched: The features_searched of this InlineResponse2003.
        :type features_searched: List[str]
        :param matched: The matched of this InlineResponse2003.
        :type matched: List[InlineResponse200Typing]
        :param act_version: The act_version of this InlineResponse2003.
        :type act_version: str
        :param gfe_version: The gfe_version of this InlineResponse2003.
        :type gfe_version: str
        :param gfedb_version: The gfedb_version of this InlineResponse2003.
    ...
    def alleles(self) -> List[str]:
        """
        Gets the alleles of this InlineResponse2003.

        :return: The alleles of this InlineResponse2003.
        :rtype: List[str]
        """
    ...
    def alleles(self, alleles: List[str]):
        """
        Sets the alleles of this InlineResponse2003.
    ...
    def features_searched(self) -> List[str]:
        """
        Gets the features_searched of this InlineResponse2003.

        :return: The features_searched of this InlineResponse2003.
        :rtype: List[str]
        """
    ...
    def features_searched(self, features_searched: List[str]):
        """
        Sets the features_searched of this InlineResponse2003.
    ...
    def matched(self) -> List[InlineResponse200Typing]:
        """
        Gets the matched of this InlineResponse2003.

        :return: The matched of this InlineResponse2003.
    ...
    def matched(self, matched: List[InlineResponse200Typing]):
        """
        Sets the matched of this InlineResponse2003.
    ...
    def act_version(self) -> str:
        """
        Gets the act_version of this InlineResponse2003.

        :return: The act_version of this InlineResponse2003.
        :rtype: str
        """
    ...
    def act_version(self, act_version: str):
        """
        Sets the act_version of this InlineResponse2003.
    ...
    def gfe_version(self) -> str:
        """
        Gets the gfe_version of this InlineResponse2003.

        :return: The gfe_version of this InlineResponse2003.
        :rtype: str
        """
    ...
    def gfe_version(self, gfe_version: str):
        """
        Sets the gfe_version of this InlineResponse2003.
    ...
    def gfedb_version(self) -> str:
        """
        Gets the gfedb_version of this InlineResponse2003.

        :return: The gfedb_version of this InlineResponse2003.
        :rtype: str
        """
    ...
    def gfedb_version(self, gfedb_version: str):
        """
        Sets the gfedb_version of this InlineResponse2003.
