...
class ArsCall(Model):
    ...
    """
    def __init__(self, allele: str=None, group_type: str=None, group: str=None, share_ars: List[Typing]=None, act_version: str=None, gfe_version: str=None, gfedb_version: str=None):
        """
        ...
        :type group: str
        :param share_ars: The share_ars of this ArsCall.
        :type share_ars: List[Typing]
    ...
    @property
    def share_ars(self) -> List[Typing]:
        """
        Gets the share_ars of this ArsCall.

        :return: The share_ars of this ArsCall.
        :rtype: List[Typing]
        """
        return self._share_ars

    @share_ars.setter
    def share_ars(self, share_ars: List[Typing]):
        """
        Sets the share_ars of this ArsCall.
    ...
    def gfe_version(self) -> str:
        """
        Gets the gfe_version of this ArsCall.

        :return: The gfe_version of this ArsCall.
        :rtype: str
        """
    ...
    def gfe_version(self, gfe_version: str):
        """
        Sets the gfe_version of this ArsCall.
