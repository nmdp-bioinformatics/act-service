...
class DefaultApi(object):
    ...
    def actformat_get(self, locus, **kwargs):
        """
        Get HLA and GFE from consensus sequence or GFE notation
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please define a `callback` function
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.actformat_get(locus, callback=callback_function)
        ...
        :param str sequence: Consensus sequence
        :param str gfe: GFE Notation
        :param str format_type: Specify the data format that will be returned
        :param str neo4j_url: URL for the neo4j graph
        :param str user: Username for the neo4j graph
        :param str password: Password for the neo4j graph
        :param str gfe_url: URL for the gfe-service
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('callback'):
            return self.actformat_get_with_http_info(locus, **kwargs)
        else:
            (data) = self.actformat_get_with_http_info(locus, **kwargs)
            return data

    def actformat_get_with_http_info(self, locus, **kwargs):
        """
        Get HLA and GFE from consensus sequence or GFE notation
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please define a `callback` function
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.actformat_get_with_http_info(locus, callback=callback_function)
        ...
        all_params = ['locus', 'sequence', 'gfe', 'format_type', 'neo4j_url', 'user', 'password', 'gfe_url', 'verbose', 'persist']
        all_params.append('callback')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
